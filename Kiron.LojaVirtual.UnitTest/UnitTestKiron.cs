...
using Kiron.LojaVirtual.Web.HtmlHelpers;
using System.Linq;

namespace Kiron.LojaVirtual.UnitTest
{
    [TestClass]
    public class UnitTestKiron
    {
        [TestMethod]
        public void Take()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestarSeAPaginacaoEstaSendoTestadaCorretamente()
        {
            //Arrange
